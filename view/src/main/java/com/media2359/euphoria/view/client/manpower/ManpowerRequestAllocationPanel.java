...
public class ManpowerRequestAllocationPanel implements IsWidget {
	...
	private static final WeeklyResourceRequestProperties props = GWT
			.create(WeeklyResourceRequestProperties.class);
	...
	public Widget asWidget() {
		...
		ColumnConfig<WeeklyResourceRequest, Float> durationCol = new ColumnConfig<WeeklyResourceRequest, Float>(
		 ...
		 */
		SimpleComboBox<Resource> combo = new SimpleComboBox<Resource>(new StringLabelProvider<Resource>());
	    combo.setPropertyEditor(new PropertyEditor<Resource>() {
	      ...
	      public String render(Resource object) {
	        return object == null ? Resource.DEVELOPER1.toString() : object.toString();
	      }
	    });
		 ...
		 */
	    SimpleComboBox<Platform> combo1 = new SimpleComboBox<Platform>(new StringLabelProvider<Platform>());
	    ...
	    editableGrid.addEditor(platformCol, new Converter<String, Platform>() {
	      ...
	      public String convertFieldValue(Platform object) {
	        return object == null ? Platform.IOS.toString() : object.toString();
	      }
		 ...
		 * Make Resource Col editable
		 */
		SimpleComboBox<DayOfWeek> combo2 = new SimpleComboBox<DayOfWeek>(new StringLabelProvider<DayOfWeek>());
		combo2.setPropertyEditor(new PropertyEditor<DayOfWeek>() {
	      ...
	      public String render(DayOfWeek object) {
	        return object == null ? DayOfWeek.MONDAY.toString() : object.toString();
	      }
	    });
	    ...
	    editableGrid.addEditor(startDateCol, new Converter<String, DayOfWeek>() {
	...
	private ArrayList<WeeklyResourceRequest> getWeeklyResourceRequests() {
	...
	GridEditing<WeeklyResourceRequest> createEditableGrid(Grid<WeeklyResourceRequest> grid) {
