...
//    interface ProjectTeamProperties extends PropertyAccess<ProjectTeam> {
//      ModelKeyProvider<ProjectTeam> projectTeamKey();
//      ValueProvider<ProjectTeam, String> role();
//      ValueProvider<ProjectTeam, Date> projectTeamMemeber();
//    }
//    
//    private static final ProjectTeamProperties props = GWT.create(ProjectTeamProperties.class);
//    private static final EmployeeDTOProperties employeeProps = GWT.create(EmployeeDTOProperties.class);
//    
//    private ListStore<ProjectMilestoneDTO> listStore;
//	
//    public ProjectTeamTab() {
